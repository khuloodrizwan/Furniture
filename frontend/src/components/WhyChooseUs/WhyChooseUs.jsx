                ...
                <div className="wcu-img-wrapper">
                    ...
                    <div className="wcu-badge">
                        ...
                        <div>
                            ...
                            <p className="wcu-badge-desc">Every piece is inspected by our curators before delivery to ensure magazine-quality condition.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="wcu-features">
                    <div className="wcu-feature">
                        ...
                        <div>
                            ...
                            <p>We source from premium designers to ensure your home looks and feels world-class.</p>
                        </div>
                    </div>
                    <div className="wcu-feature">
                        <div className="wcu-feature-icon">🔧</div>
                        <div>
                            ...
                            <p>Free periodic cleaning and repairs included. We keep your environment pristine.</p>
                        </div>
                    </div>
                    <div className="wcu-feature">
                        <div className="wcu-feature-icon">📅</div>
                        <div>
                            ...
                            <p>From 3 to 24 months. Change your mind? Change your plan. No hidden fees.</p>
                        </div>
                    </div>
                </div>
            </div>
